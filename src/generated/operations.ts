...
export type LoginMutation = {
  login: { id: string; name: string; email: string; role: Types.UserRole };
};
...
export type MeQuery = {
  me: { id: string; name: string; email: string; role: Types.UserRole } | null;
};
...
export type SignupMutation = {
  signup: { id: string; name: string; email: string; role: Types.UserRole };
};
...
export class ApplyForJobGQL extends Apollo.Mutation<
  ApplyForJobMutation,
  ApplyForJobMutationVariables
> {
...
export class CancelJobApplicationGQL extends Apollo.Mutation<
  CancelJobApplicationMutation,
  CancelJobApplicationMutationVariables
> {
